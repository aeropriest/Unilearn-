...
export default function PricingFaq() {
  ...
  const faqData = {
    learners: [
      {
        question: `${t('pricingFAQs.learners_question_One')}`,
        answer: `${t('pricingFAQs.learners_answer_One')}`,
      },
      {
        question: `${t('pricingFAQs.learners_question_Two')}`,
        answer: `${t('pricingFAQs.learners_answer_Two')}`,
      },
      {
        question: `${t('pricingFAQs.learners_question_Three')}`,
        answer: `${t('pricingFAQs.learners_answer_Three')}`,
      }
    ],
    mentors: [
      {
  ...
  return (
    <section className="w-full px-4 py-16 text-center mt-[0px] lg:mt-[100px] max-w-[1920px] max-h-[2552px] mx-auto">
      {/* Title */}
      <div className="mb-12">
        <p
          className="text-[16px] sm:text-[20px] lg:text-[24px] 
             text-brand-pink font-comfortaa font-bold 
             text-center mb-4 tracking-wide w-full"
        >
          {t('pricingFAQs.FAQs')}
        </p>
        ...
        <h1
          className="text-[16px] sm:text-[28px] lg:text-[42px] 
             leading-[20px] sm:leading-[32px] lg:leading-[42px]
             text-center text-brand-blue font-rocksalt font-normal 
             mb-6 max-h-[85px]"
          style={{
        ...
        >
          {t('pricingFAQs.frequently_Asked_Questions')}
        </h1>
      </div>
        ...
        <div className="inline-flex rounded-full bg-gradient-to-r from-[#B8D6FF] to-[#A6E3EE] p-[1px]">
          <div className="flex gap-1 rounded-full bg-white px-1 py-1 lg:w-[400px] lg:h-[52]">
            {['learners', 'mentors'].map((tab) => {
              ...
              ${isActive
                    ? 'text-white bg-gradient-to-r from-[#80B9FF]/80 to-[#3DB0CB]/80'
                      : 'text-brand-skyBlue bg-transparent'
                    }`}
                >
                  {tab === 'learners' ? `${t('pricingFAQs.learners')}` : `${t('pricingFAQs.mentors')}`}
                </Button>
              );
            })}
          </div>
