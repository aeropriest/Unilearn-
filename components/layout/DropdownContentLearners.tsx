...
export const DropdownContentLearners = ({ setActiveDropdown }) => {
    ...
    <div className="container mx-auto px-4">
      {/* <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto"> */}
        ...
        <div
          ...
          // className="lg:col-span-1 w-[390px] h-[470px]"
        ...
        >
          ...
          >
            ...
            <CardContent className="p-0">
              <div className="mb-4">
                <Image
                  src="/images/ForLearners.png?height=200&width=300"
              ...
              >
                {t('forLearners.what_type')}
              </h2>
              <Link href="/learnersQuiz" className="flex items-center space-x-2 mb-[120px]">
                <Button
                  size="sm"
                  className="text-[#F25D90] text-[20px] leading-[20px] font-bold font-[Comfortaa] text-center px-3 py-1 flex items-center gap-2"
                >
                  {t('forLearners.take_quiz')}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                      ...
                      <h4 
                        ...
                        //   setActiveDropdown(null);
                        // }}
                      // onClick={() => window.open(`${process.env.NEXT_APP_FRONTEND_BASE_URL}/en/instructors#/`, "_blank")}
                    ...
                    >
                        {t('forLearners.learning_Projects')}
                      ...
                      >
                        {t('forLearners.customize_your_learning')} 
                      </p>
                    {/* <p
                      className="mt-2 flex flex-col justify-center flex-[1_0_0] self-stretch text-[18px] leading-[18px] font-normal text-[#282828] font-[Comfortaa]"
                    >
                        {t('forLearners.create_dynamic_paths')}
                    </p> */}
                  ...
                  <div className="flex items-center gap-[12px] mt-[55px] mb-[55px]">
                    ...
                    <h4
                      // onClick={() =>
                      //   window.open(`${process.env.NEXT_APP_FRONTEND_BASE_URL}/en/projects/browse#/`, '_blank')
                      // }
                      // onClick={() => {
                      //   window.open(
                      //     `${process.env.NEXT_APP_FRONTEND_BASE_URL}/en/projects/browse#/`,
                    ...
                    <p
                      className="mt-2 flex flex-col justify-center flex-[1_0_0] self-stretch text-[18px] leading-[18px] font-normal text-[#282828] font-[Comfortaa]"
                    >
                      {t('forLearners.get_support_as_needed')}
                    </p>
                  </div>
                  </div>
                  ...
                  <div className="flex items-center gap-[12px]">
                    ...
                    <div className="flex flex-col">
                      <h4
                        ...
                        className="text-[28px] leading-none font-normal text-[#004699] font-[Questrial] cursor-pointer"
                        style={{
                          WebkitTextStrokeWidth: "0.5px",
                          WebkitTextStrokeColor: "#004699",
                        }}
                      >
                        {t("forLearners.co_Learning")}
                      </h4>

                      <p
                        className="mt-2 flex flex-col justify-center flex-[1_0_0] self-stretch text-[18px] leading-[18px] font-normal text-[#282828] font-[Comfortaa]"
                      >
                        {t("forLearners.learn_with_your_pals")}
                      </p>
                    </div>
                  </div>
              ...
              <div className="">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    >
                        {t('forLearners.help_Center')}
                    </h4>
                    </Link>
                      <p
                        className="mt-2 flex flex-col justify-center flex-[1_0_0] self-stretch text-[18px] leading-[18px] font-normal text-[#282828] font-[Comfortaa]"
                      >
                        {t('forLearners.get_the_help_you_need')}
                      </p>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-4 mt-[55px]">
                    ...
                    <div>
                      ...
                      <p
                        className="mt-2 flex flex-col justify-center flex-[1_0_0] self-stretch text-[18px] leading-[18px] font-normal text-[#282828] font-[Comfortaa]"
                      >
                        {t('forLearners.check_out_latest_updates')}
                      </p>
                  ...
                  <div className="flex items-center gap-4 mt-[55px]">
                    ...
                    <div>
                      ...
                      <p
                        className="mt-2 flex flex-col justify-center flex-[1_0_0] self-stretch text-[18px] leading-[18px] font-normal text-[#282828] font-[Comfortaa]"
                      >
                        {t('forLearners.get_started_for_free')}
                      </p>
